<x-layouts.app>
    ...
    <flux:breadcrumbs>
        ...
        <flux:breadcrumbs.item>{{ $scoring->scoringQuiz->name }}</flux:breadcrumbs.item>
    </flux:breadcrumbs>
    ...
    <div class="mt-8">
        ...
        <p>Vous trouverez ci dessous les {{ count($scoring->scoringQuiz->scoringSections) }} thèmes de l'audit.
            Il vous reste actuellement <b>{{ $scoring_questions_count - $scoring_answers_count }} questions</b>
            auxquelles
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            @foreach ($scoring->scoringQuiz->scoringSections as $section)
                <a href="{{ route('scorings.scoring-sections.show', [$scoring, $section]) }}" wire:navigate>
                    ...
                    <x-card class="bg-white px-4 py-4 hover:bg-indigo-200 h-48">
                        <div class="flex">
